...
public abstract class AbstractCategoryAPI<T extends APITransferRecipe> extends VariantCategory<RecipeHolder<T>> {
    private final IDrawable background;
    private final IDrawable icon;
    private final Component localizedName;
    private final LoadingCache<Integer, IDrawableAnimated> cachedArrows;

    public AbstractCategoryAPI(IGuiHelper guiHelper, Item icon, String translationKey) {
        super(guiHelper);
