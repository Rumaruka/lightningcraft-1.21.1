...
public abstract class TransferAbstractCategory<T extends TransformRecipe> extends VariantCategory<RecipeHolder<T>> {
    ...
    public TransferAbstractCategory(IGuiHelper guiHelper, Item icon, String translationKey, int regularCookTime) {
        super(guiHelper);
