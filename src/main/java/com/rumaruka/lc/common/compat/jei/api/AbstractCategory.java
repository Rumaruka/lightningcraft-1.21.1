...
public abstract class AbstractCategory<T extends AbstractCustomRecipe> extends VariantCategory<RecipeHolder<T>> {
    private final IDrawable background;
    private final IDrawable icon;
    private final Component localizedName;
    private final LoadingCache<Integer, IDrawableAnimated> cachedArrows;

    public AbstractCategory(IGuiHelper guiHelper, Item icon, String translationKey) {
        super(guiHelper);
